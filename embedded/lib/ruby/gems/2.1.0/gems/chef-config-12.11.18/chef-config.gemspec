# -*- encoding: utf-8 -*-
# stub: chef-config 12.11.18 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE".freeze, "README.md".freeze, "Rakefile".freeze, "chef-config.gemspec".freeze, "lib/chef-config.rb".freeze, "lib/chef-config/config.rb".freeze, "lib/chef-config/exceptions.rb".freeze, "lib/chef-config/fips.rb".freeze, "lib/chef-config/logger.rb".freeze, "lib/chef-config/mixin/dot_d.rb".freeze, "lib/chef-config/mixin/fuzzy_hostname_matcher.rb".freeze, "lib/chef-config/package_task.rb".freeze, "lib/chef-config/path_helper.rb".freeze, "lib/chef-config/version.rb".freeze, "lib/chef-config/windows.rb".freeze, "lib/chef-config/workstation_config_loader.rb".freeze, "spec/spec_helper.rb".freeze, "spec/unit/config_spec.rb".freeze, "spec/unit/fips_spec.rb".freeze, "spec/unit/path_helper_spec.rb".freeze, "spec/unit/workstation_config_loader_spec.rb".freeze]
